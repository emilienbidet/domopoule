...
{
  t = rtc.getTime();
  if ((t.hour == V_HeureOuv && t.min == V_MinOuv && (t.sec > 0 && t.sec < 10)) ||
      (t.hour == V_HeureOuv2 && t.min == V_MinOuv2 && (t.sec > 0 && t.sec < 10)))
  {
    if (ModedemarcheOuv == 1 && (Etattrappe == 0 || Etattrappe == 1) && MouvTrappe == 0 && Defautporte == 0)
    {
      DemEtattrappe = 2;
    }
  }
  if ((t.hour == V_HeureFerm && t.min == V_MinFerm && (t.sec > 0 && t.sec < 10)) ||
      (t.hour == V_HeureFerm2 && t.min == V_MinFerm2 && (t.sec > 0 && t.sec < 10)))
  {
    if (ModedemarcheFerm == 1 && (Etattrappe == 2 || Etattrappe == 1) && MouvTrappe == 0 && Defautporte == 0)
    {
      DemEtattrappe = 0;
    }
  }
