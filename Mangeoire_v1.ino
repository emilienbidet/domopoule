...
byte V_MinOuv = 23;         //Stock valeur Minute pour Progr Minute ouverture
byte V_HeureOuv = 11;       //Stock valeur Heure pour Progr Heure ouverture
byte V_MinFerm = 23;        //Stock valeur Minute pour Progr Minute fermeture
byte V_HeureFerm = 23;      //Stock valeur Heure pour Progr Heure fermeture
