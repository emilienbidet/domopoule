...
void navmenuboutonselect() {
  ...
  if (MenuMdm == 3) {
    MenuMdm = 0; MenuMdmOuv = 1;
  }
  if (MenuMdm == 4) {
    MenuMdm = 0; MenuMdmFerm = 1;
  }
  if (MenuMdm == 5) {
    MenuMdm = 0; Menu = 1; Sav();
  }
  if (MenuMdmOuv == 3) {
    MenuMdmOuv = 0; MenuMdm = 1; ModedemarcheOuv = 1;
  }
  if (MenuMdmOuv == 4) {
    MenuMdmOuv = 0; MenuMdm = 1; ModedemarcheOuv = 2;
  }
  if (MenuMdmOuv == 5) {
    MenuMdmOuv = 0; MenuMdm = 1; ModedemarcheOuv = 3;
  }
  if (MenuMdmOuv == 11) {
    MenuMdmOuv = 0; MenuMdm = 1;
  }
  if (MenuMdmFerm == 3) {
    MenuMdmFerm = 0; MenuMdm = 1; ModedemarcheFerm = 1;
  }
  if (MenuMdmFerm == 4) {
    MenuMdmFerm = 0; MenuMdm = 1; ModedemarcheFerm = 2;
  }
  if (MenuMdmFerm == 5) {
    MenuMdmFerm = 0; MenuMdm = 1; ModedemarcheFerm = 3;
  }
if (MenuMdmFerm == 11) {
    MenuMdmFerm = 0; MenuMdm = 1;;
  }  
  if (MenuPara == 11) {
    MenuPara = 0; Menu = 1;
  }
  ...
  if (ParaSecumoteuretat == 3) {
    ParaSecumoteuretat = 0; MenuParaSecu = 1; Sav();
  }
  if (ParaSecumoteurTpsactiv == 3) {
    ParaSecumoteurTpsactiv = 0; MenuParaSecu = 1; Sav();
  }
  if (MenuParaProg == 3) {
  ...
  if(MenuParaSecu == 3){
    ParaSecumoteuretat = 1; MenuParaSecu = 0;
  }
  if(MenuParaSecu == 4){
    ParaSecumoteurTpsactiv = 1; MenuParaSecu = 0;
  }
  if(MenuParaSecu == 5){
    MenuPara = 1; MenuParaSecu = 0;
  }
  if (SystReglheure == 3) {
    SystReglheure = 4;
  }
